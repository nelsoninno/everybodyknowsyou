...
- 2026-07-29: Added hero images + card thumbnails to articles. New images/articles/the-economy-of-digital-trust.jpg (EKY El Salvador binocular illustration, 1200x900) and images/articles/digital-presence-ai-era.jpg (founder photo Marcela Lemus Walsh + Nelson Inno, 1400x933). Each article now has a full-width hero (with width/height for CLS), the article index cards show thumbnails (16:9 cover), and each article's OG/Twitter image + Article JSON-LD image point to its own image. Article template gained og_image param, .article-hero, .art-thumb/.art-body CSS.
